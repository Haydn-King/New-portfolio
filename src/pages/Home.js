  ...
  return (
    <div>
      ...
      <div className="container">
        <div className="row justify-content-start">
          <div className="col-md-4">
            <div
              className="n-box2 p-5 font-bold"
              data-aos="fade-right">
              <h1>Yes you are right...</h1>
              <br />
              <p>I am always looking to expand my knowledge...</p>
            </div>
          </div>
        </div>
        ...
        <div className="row pt-5 justify-content-end">
          <div className="col-md-4">
            <div
              ...
              data-aos="fade-left">
              <p>
                JavaScript is one of the most top-ranked
                programming languages because of its
                ubiquitous use on all platforms and mass
      ...
      <div>
        ...
        <div
          className="who-is-andrew flex-with-center"
          style={{
            backgroundImage: `url('/whoissathya.svg')`,
          }}>
          <div>
            <h3>Hey, Hi, Hello</h3>
            <hr />
